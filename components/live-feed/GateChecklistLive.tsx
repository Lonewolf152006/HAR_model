        ...
        <span
          className={`font-mono text-[9px] px-1.5 py-0.5 rounded-[2px] border font-bold bezel-depth-subtle ${
            allPassed
              ...
              : "bg-[#1A0E10] text-[#FF4D4F] border-[#FF4D4F]/60 glow-critical animate-pulse"
          }`}
        >
          ...
          >
            <div className="flex items-center gap-1.5 min-w-0">
              {gate.passed ? (
                ...
                <XCircle className="w-3.5 h-3.5 text-[#FF4D4F] glow-critical shrink-0 animate-pulse" />
              )}
              <div className="min-w-0">
                ...
                <div
                  className={`text-[9px] leading-tight truncate ${
                    gate.passed ? "text-[#8A919C]" : "text-[#FF4D4F]"
                  }`}
                >
                  {gate.reason}
                </div>
              ...
              <span
                className={`text-[9px] font-bold px-1 py-0.2 rounded-[1px] ${
                  gate.passed
                    ...
                    : "text-[#FF4D4F] glow-critical bg-[#FF4D4F]/10"
                }`}
              >
